...
import java.net.URL;
public class DeleteStudentWrongDeletedTest {
  ...
  @Test
  public void deleteStudentWrongDeleted() {
    ...
    driver.findElement(By.xpath("/html/body/app-root/div/app-add-student/div[1]/div[2]/div/form/div[1]/input")).sendKeys("Bojana");
    ...
    assertThat(driver.findElement(By.cssSelector("td:nth-child(1)")).getText(), is("Bojana"));
  }
}
